...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <h1 className="transition duration-100 text-center mb-8 cursor-pointer hover:text-pink-600 text3xl font-semibold">
        <Link href={`/post/${post.slug}`}>{post.title}</Link>
      </h1>
      <div className="block lg:flex text-center items-center place-items-center justify-center mb-8 w-full">
        <div className="flex items-center place-items-center justify-center mb-4 lg:mb-0 w-full  lg:w-auto mr-8">
          <img
